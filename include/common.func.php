...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg = $func;
        $rmsg .= "document.write(\"<br /><div style='width:850px;padding:0px;border:1px solid #DADADA;margin-top:100px;'>";
        $rmsg .= "<div style='padding:6px;font-size:16px;color:#fff; border-bottom:1px solid #DADADA;background:#d9534f; url({$GLOBALS['cfg_plus_dir']}/img/wbg.gif)';'><b>站窝窝  提示信息！</b></div>\");\r\n";
        $rmsg .= "document.write(\"<div style='height:430px;font-size:14pt;background:#ffffff'><br />\");\r\n";
        ...
        if($onlymsg==0)
        {
            ...
            {
                $rmsg .= "<br /><a href='{$gourl}' style='color:#d9534f;text-decoration : none;'>如果你的浏览器没反应，请点击这里...</a>";
                $rmsg .= "<br/></div>\");\r\n";
